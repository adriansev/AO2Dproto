...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           fIndexBCs;
   Float_t         fAmplitudeA[96];
   Float_t         fAmplitudeC[112];
   Float_t         fTimeA;
   Float_t         fTimeC;
...
#ifdef O2ft0_cxx
O2ft0::O2ft0(TTree *tree) : fChain(0) 
{
...
Int_t O2ft0::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t O2ft0::LoadTree(Long64_t entry)
{
...
void O2ft0::Show(Long64_t entry)
{
...
Int_t O2ft0::Cut(Long64_t entry)
{
