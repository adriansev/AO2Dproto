...
#ifdef O2fv0a_cxx
O2fv0a::O2fv0a(TTree *tree) : fChain(0) 
{
...
Int_t O2fv0a::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t O2fv0a::LoadTree(Long64_t entry)
{
...
void O2fv0a::Show(Long64_t entry)
{
...
Int_t O2fv0a::Cut(Long64_t entry)
{
