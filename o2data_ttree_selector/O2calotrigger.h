...
class O2calotrigger : public TSelector {
public :
   ...
   TTreeReaderValue<Short_t> fFastOrAbsID = {fReader, "fFastOrAbsID"};
   TTreeReaderValue<Short_t> fLnAmplitude = {fReader, "fLnAmplitude"};
   TTreeReaderValue<Int_t> fTriggerBits = {fReader, "fTriggerBits"};
   TTreeReaderValue<Char_t> fCaloType = {fReader, "fCaloType"};
