...
public :
   ...
   TTreeReaderValue<Short_t> fCellNumber = {fReader, "fCellNumber"};
   TTreeReaderValue<Float_t> fAmplitude = {fReader, "fAmplitude"};
   TTreeReaderValue<Float_t> fTime = {fReader, "fTime"};
   TTreeReaderValue<Char_t> fCellType = {fReader, "fCellType"};
